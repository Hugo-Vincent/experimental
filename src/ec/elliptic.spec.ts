...
const mnemonic =
  'quality verify damage nominee dinner plunge bargain treat feel time rude skin sword fiscal welcome oppose enough palace fat matter view clerk illness exhaust';
...
describe('Comparison between two signing functions', () => {
  ...
  it('entropy to mnem and mnem to key', () => {
    const entropy =
      'af3e54dc4af3e54dc4af3e54dc4af3e54dc4af3e54dc4af3e54dc4af3e54dc4a';
  ...
  it('Current sign', () => {
    ...
    expect(signature).toBe(
      '3046022100dfa08f167447f861eed4e61da8e996788b7cea601ce5cf9789c3be378781a56b022100fdbe055bc839f18077eef70da7659d9c02dac66244f579f50972fb35c642fdce',
    );
  });
  it('Proposed sign', () => {
    ...
    expect(signature).toBe(
      '304402202129fa530319f026534fb767eb315cbdf3e727e965e330456abcc3b2ad1f37bb022058ba41690ca4834574f619f5d0761efc7f9e16e5a9eae06da1a7655cff6ddeb9',
    );
  });
});
describe('a', () => {
