const _CONTRACT_TERMINATION_REASONS = {
...
export type TTerminationReasonKey = keyof typeof _CONTRACT_TERMINATION_REASONS;
export type TTerminationReason = typeof _CONTRACT_TERMINATION_REASONS[TTerminationReasonKey];
export const CONTRACT_TERMINATION_REASONS: Record<TTerminationReasonKey, TTerminationReason> = _CONTRACT_TERMINATION_REASONS;
