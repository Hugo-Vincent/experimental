...
export const CONTRACT_TO_FUNCTIONS_MAPPING: Record<TContract, EFunctions[]> = {
  ...
  [EContracts.UNISCAPE_COLT]: [],
  [EContracts.EXPO]: [],
  [EContracts.GITHUB]: [],
  [EContracts.HEXNODE]: [EFunctions.FUNCTION_13_IT_SYSTEM_MNGMNT],
  [EContracts.IDIN_VIA_BLUEM]: [EFunctions.FUNCTION_1_CLIENT_ONBOARDING],
  ...
  [EContracts.SCRIVE_VIA_BLUEM]: [EFunctions.FUNCTION_1_CLIENT_ONBOARDING],
  [EContracts.SENDGRID_VIA_TWILIO]: [EFunctions.FUNCTION_1_CLIENT_ONBOARDING, EFunctions.FUNCTION_11_MARKETING_COMMUNICATION, EFunctions.FUNCTION_12_EMAILING, EFunctions.FUNCTION_14_INVOICING],
  [EContracts.SENTRY]: [],
  [EContracts.SLACK]: [],
  [EContracts.SONARCLOUD]: [],
  [EContracts.SUREPAY_VIA_BLUEM]: [EFunctions.FUNCTION_1_CLIENT_ONBOARDING],
